...
public class plgCODGeneralCommands extends Plugin
{	
	// ********************************************************************************
    //          CONSTRUCTOR
    // ********************************************************************************
    
	public plgCODGeneralCommands()
	{
		// set plugin information
		name = "COD General Commands";
		...
		ph.register("!kick", "cmdKick", ACCESS.GLOBAL, LEVEL.HALFOP, this);
		ph.register("!ban", "cmdBan", ACCESS.GLOBAL, LEVEL.HALFOP, this);
		ph.register("!kickban", "cmdKickBan", ACCESS.GLOBAL, LEVEL.HALFOP, this);
